            ...
            <>
              ...
              <section className="cc-form-section">
                ...
                <label className="cc-priv-check">
                  ...
                  />
                  Ver Región (maestro: todos los canales y seguimiento)
                </label>
                <label className="cc-priv-check">
                  <input
                    type="checkbox"
                  ...
                  />
                  Ver Zonas / C.G. (unidades subordinadas + seguimiento)
                </label>
                <label className="cc-priv-check">
                  <input
                    type="checkbox"
                  ...
                  />
                  Ver Unidades (servicios desplegados / usuarios de la unidad)
                </label>
              </fieldset>
              </section>
              <div className="field field-actions cc-form-actions">
