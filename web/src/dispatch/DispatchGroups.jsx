    ...
    <div className="dispatch-page cc-groups-page cc-cat-compact">
      ...
      <div className="cc-groups-list-wrap">
        <ul className="cc-groups-list">
          {groups.map((g) => (
            <li key={g.id} className={`cc-group-card${selectedGroupId === g.id ? ' is-selected' : ''}`}>
      ...
      {selectedGroupId && (
        <section className="members-panel cc-groups-members">
          <h2>
            ...
            <div className="cc-cat-chips">
              {members.map((m) => (
                <div key={m.id} className="cc-dep-org-chip cc-group-member-chip">
                  ...
                  {canManage && (
                    <button type="button" className="cc-cat-rm" title="Quitar" onClick={() => kickMember(m.id)}>
                      ×
                    </button>
                  )}
                </div>
